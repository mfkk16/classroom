...
import 'package:classroom/precentation/pages/registrations/registration_details_page.dart';
import 'package:classroom/precentation/pages/registrations/registration_new.dart';
...
Route<dynamic> generateRoutes(RouteSettings settings) {
  switch (settings.name) {
    ...
    case studentsPage:
      return MaterialPageRoute(builder: (context) => StudentsPage(isSelection: settings.arguments as bool));
    case subjectsPage:
      return MaterialPageRoute(builder: (context) => SubjectsPage(isSelection: settings.arguments as bool));
    case classroomsPage:
    ...
    case subjectDetailsPage:
      return MaterialPageRoute(builder: (context) => SubjectsDetailsPage(subjectEntity: settings.arguments as SubjectEntity));
    case studentsDetailsPage:
      return MaterialPageRoute(builder: (context) => StudentsDetailsPage(studentEntity: settings.arguments as StudentEntity));
    case classroomDetailsPage:
      return MaterialPageRoute(builder: (context) => ClassroomDetailsPage(classroomEntity: settings.arguments as ClassroomEntity));
    case registrationDetailsPage:
      return MaterialPageRoute(builder: (context) => RegistrationDetailsPage(registrationEntity: settings.arguments as RegistrationEntity));
    case registrationNewPage:
      return MaterialPageRoute(builder: (context) => const RegistrationNew());
